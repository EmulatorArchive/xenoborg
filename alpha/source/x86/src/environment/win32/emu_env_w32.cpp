...
struct emu_env_w32_known_dll_segment kernel32_segments[] = 
{
	{
		0x7c800000,
		kernel32_dll_7c800000,
		641,
	},
	{
		0x7c801000,
		kernel32_dll_7c801000,
		32625,
	},
	{ 0, NULL, 0 }
};
...
//		if ( strncasecmp(dllname, known_dlls[i].dllname, strlen(known_dlls[i].dllname)) == 0 )
		if ( strcmp(dllname, known_dlls[i].dllname) == 0 )
		{
			...
			*env->loaded_dlls = (emu_env_w32_dll*) realloc(env->loaded_dlls, sizeof(struct emu_env_w32_dll *) * (numdlls+2));
